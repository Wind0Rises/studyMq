 ...
 */
public class SecondConsumerTest {
    ...
    public static void haveTransaction() throws Exception {
        ...
        consumer.createTransactionConsumer();
    }
    ...
    public static void noTransactionAndAuto() throws Exception {
        SecondConsumer consumer = new SecondConsumer();
        consumer.createNonTransactionConsumer(Session.AUTO_ACKNOWLEDGE);
    }
    ...
    public static void noTransactionAndClient() throws Exception {
        SecondConsumer consumer = new SecondConsumer();
        consumer.createNonTransactionConsumer(Session.CLIENT_ACKNOWLEDGE);
    }
}
